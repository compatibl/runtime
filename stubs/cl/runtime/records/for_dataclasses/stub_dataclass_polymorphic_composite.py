...
class StubDataclassPolymorphicComposite(StubDataclassPolymorphicCompositeKey, RecordMixin):
    ...
    def get_key(self) -> StubDataclassPolymorphicCompositeKey:
        return StubDataclassPolymorphicCompositeKey(
            base_key_field=self.base_key_field,
            root_key_field=self.root_key_field,
        ).build()
