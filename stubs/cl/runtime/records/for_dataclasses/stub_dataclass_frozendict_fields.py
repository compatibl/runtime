...
class StubDataclassFrozendictFields(StubDataclass):
    ...
    data_frozendict: frozendict[str, StubDataclassData] = required(default_factory=stub_dataclass_data_frozendict_factory)
    """Stub field."""

    key_frozendict: frozendict[str, StubDataclassKey] = required(default_factory=stub_dataclass_key_frozendict_factory)
    """Stub field."""

    record_frozendict: frozendict[str, StubDataclass] = required(default_factory=stub_dataclass_record_frozendict_factory)
    """Stub field."""

    derived_frozendict: frozendict[str, StubDataclassDerived] = required(default_factory=stub_dataclass_derived_frozendict_factory)
    """Stub field."""
