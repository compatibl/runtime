...
def test_single_group(work_dir_fixture):
    ...
    guard = RegressionGuard(ext="png", prefix="test_group_bar_plot.group_bar_plot").build()
...
def test_4_groups_2_bars(work_dir_fixture):
    ...
    # Create regression guard
    guard = RegressionGuard(ext="png", prefix="test_group_bar_plot.test_4_groups_2_bars").build()
...
def test_4_groups_5_bars(work_dir_fixture):
    ...
    # Create regression guard
    guard = RegressionGuard(ext="png", prefix="test_group_bar_plot.test_4_groups_5_bars").build()
