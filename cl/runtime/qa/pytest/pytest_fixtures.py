...
def _db_fixture(request: FixtureRequest, *, db_type: type | None = None) -> Iterator[Db]:
    ...
    test_name = PytestUtil.get_test_path_from_request(request, format_as="name")
...
def work_dir_fixture(request: FixtureRequest) -> Iterator[str]:
    ...
    work_dir = PytestUtil.get_test_path_from_request(request, format_as="dir")
