...
class TypeCache:
    ...
    @classmethod
    def to_type_name(cls, type_: type) -> str:
        """
        Get type name generated by TypeUtil.name(...) method from the type, defaults to
        ClassName except when alias is defined to resolve a name collision.
        """
        return TypeUtil.name(type_)

    @classmethod
    def to_qual_name(cls, type_: type) -> str:
    ...
    def from_type_name(cls, type_name: str) -> type:
        """
        Get type from type name generated by TypeUtil.name(...) method, defaults to
        ClassName except when alias is defined to resolve a name collision.
        """
    ...
    def _build_child_type_names(cls, class_: type) -> tuple[str, ...]:
        ...
        subtypes = [TypeUtil.name(class_)] if is_data_key_or_record(class_) else []  # Include self in subtypes
    ...
    def _add_class(cls, class_: type, *, subtype: str | None = None) -> None:
        ...
        qual_name = cls.to_qual_name(class_)
