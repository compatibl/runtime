...
class Db(DbKey, RecordMixin, ABC):
    ...
    def drop_test_db(self) -> None:
        ...
        - The method is invoked from a unit test based on active_or_default(EnvContext).testing
    ...
    def _get_test_db_name(cls) -> str:  # TODO: Use fixture instead
        ...
        if active_or_default(EnvContext).testing:
    ...
    def create(cls, *, db_type: type | None = None, db_id: str | None = None):
        ...
        if db_id is None:
            if not active_or_default(EnvContext).testing:
