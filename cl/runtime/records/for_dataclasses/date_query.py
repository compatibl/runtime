...
class DateQuery(PrimitiveQuery):
    """Query for a date field."""

    exists: bool | None = None
    """Matches values other than None if exists=True, matches None if exists=False."""

    eq: dt.date | None = None
    """Equal."""

    in_: List[dt.date] | None = None
    """Equal to at least one item in the sequence."""

    lt: dt.date | None = None
    """Less than."""

    lte: dt.date | None = None
    """Less than or equal."""

    gt: dt.date | None = None
    """Greater than."""

    gte: dt.date | None = None
